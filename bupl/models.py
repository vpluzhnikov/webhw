...
#    id = models.CharField(max_length=765, primary_key=True)
    ...
    dcmcod_rent_price = models.DecimalField(u'Стоимость аренды МегаЦОД (без НДС, руб.)', max_digits=65, decimal_places=30)
    drdc_rent_price = models.DecimalField(u'Стоимость аренды АЦОД (без НДС, руб.)', max_digits=65, decimal_places=30)
