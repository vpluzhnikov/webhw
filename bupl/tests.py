...
class EosTestCase(unittest.TestCase):
    def setUp(self):
        ...
        Prices.objects.create(id=6, hw_class=2.00, hw_type="upg_ppc_mid", price=19321.000000000000000000000000000000,
            dc_rent_price=0, dc_book_price=0, dc_startup_price=0)
        Prices.objects.create(id=7, hw_class=2.00, hw_type="upg_sparc_hiend",
            price=12800.000000000000000000000000000000, dc_rent_price=0, dc_book_price=0, dc_startup_price=0)
        ...
        Prices.objects.create(id=33, hw_class=4.00, hw_type="symantec_lic", price=2000.000000000000000000000000000000,
            dc_rent_price=0, dc_book_price=0, dc_startup_price=0)
        Prices.objects.create(id=34, hw_class=5.00, hw_type="symantec_support",
        ...
        Prices.objects.create(id=39, hw_class=5.00, hw_type="ms_lic_2sock", price=2400.000000000000000000000000000000,
            dc_rent_price=0, dc_book_price=0, dc_startup_price=0)
        Prices.objects.create(id=40, hw_class=5.00, hw_type="vmware_lic_2sock",
            price=6682.000000000000000000000000000000, dc_rent_price=0, dc_book_price=0, dc_startup_price=0)
        Prices.objects.create(id=41, hw_class=5.00, hw_type="vmware_support_2sock",
            price=1659.000000000000000000000000000000, dc_rent_price=0, dc_book_price=0, dc_startup_price=0)
        Prices.objects.create(id=42, hw_class=5.00, hw_type="rhel_support_2sock",
